...
from compdfkit.param import CPDFToPPTParameter
...
def pdf_to_pptx():
    # create Task
    create_task_result = client.create_task(CPDFConversionEnum.PDF_TO_PPT)
    # taskId
    task_id = create_task_result.task_id
    # upload File
    file = "sample/test.pdf"
    file_password = ""
    file_parameter = CPDFToPPTParameter()
    file_parameter.is_contain_img(CPDFToPPTParameter.IS_CONTAIN_IMG)
