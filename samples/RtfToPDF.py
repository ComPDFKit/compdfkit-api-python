...
from compdfkit.param import CRTFToPDFParameter
...
def rtf_to_pdf():
    # Create Task
    create_task_result = client.create_task(CPDFConversionEnum.RTF_TO_PDF)
    # TaskId
    task_id = create_task_result.task_id
    # Upload File
    file = "sample/test.rtf"
    file_password = ""
    file_parameter = CRTFToPDFParameter()
