...
from compdfkit.param import CPDFPageDeleteParameter
...
def page_delete():
    # Create Task
    create_task_result = client.create_task(CPDFDocumentEditorEnum.DELETE)
    # TaskId
    task_id = create_task_result.task_id
    # Upload File
    file = "sample/test.pdf"
    file_password = ""
    file_parameter = CPDFPageDeleteParameter()
